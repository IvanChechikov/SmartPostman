...
def work():
    try:
        ...
        response["response"]["text"] = "Что то пошло не так, повторите предыдущую команду или начните сначала."
        response["response"]["tts"] = "Что то пошл+о не так, повтор+ите предыд+ущую ком+анду или начн+ите снач+ала."
